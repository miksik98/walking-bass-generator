...
ionian = Scale([0, 2, 4, 5, 7, 9, 11], "ionian", 10, ScaleCharacter.TONIC)
dorian = Scale([0, 2, 3, 5, 7, 9, 10], "dorian", 10, ScaleCharacter.TONIC)
phrygian = Scale([0, 1, 3, 5, 7, 9, 10], "phrygian", 10, ScaleCharacter.TONIC)
lydian = Scale([0, 2, 4, 6, 7, 9, 11], "lydian", 10, ScaleCharacter.TONIC)
mixolydian = Scale([0, 2, 4, 5, 7, 9, 10], "mixolydian", 10, ScaleCharacter.DOMINANT)
aeloian = Scale([0, 2, 3, 5, 7, 8, 10], "aeolian", 10, ScaleCharacter.TONIC)
locrian = Scale([0, 1, 3, 5, 6, 8, 10], "locrian", 10, ScaleCharacter.DOMINANT)

melodic_minor = Scale([0, 2, 3, 5, 7, 9, 11], "melodic minor", 10, ScaleCharacter.TONIC)
dorian_b2 = Scale([0, 1, 3, 5, 7, 9, 10], "dorian b2", 10, ScaleCharacter.TONIC)
lydian_aug = Scale([0, 2, 4, 6, 8, 9, 11], "lydian augmented", 10, ScaleCharacter.TONIC)
lydian_dominant = Scale([0, 2, 4, 6, 7, 9, 10], "lydian dominant", 10, ScaleCharacter.DOMINANT)
mixolydian_b6 = Scale([0, 2, 4, 5, 7, 8, 10], "mixolydian b6", 10, ScaleCharacter.DOMINANT)
locrian_sharp2 = Scale([0, 2, 3, 5, 6, 8, 10], "locrian #2", 10, ScaleCharacter.DOMINANT)
altered = Scale([0, 1, 3, 4, 6, 8, 10], "altered", 10, ScaleCharacter.DOMINANT)
...
# augmented = Scale([0, 3, 4, 7, 8, 11], "augmented", 5, ScaleCharacter.TONIC)
