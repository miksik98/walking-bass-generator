...
class Chromosome:
    ...
    def arr(self):
        return [self.gene1, self.gene2, self.gene3]


equation_inputs = Chromosome(4, -2, 3.5)
desired_output = 44

def fitness_func(ga_instance, solution, solution_idx):
    output = numpy.sum(solution * equation_inputs.arr())
...
ga_instance = pygad.GA(num_generations=10,
                       initial_population=[Chromosome(1,1,1) for _ in range(10)],
